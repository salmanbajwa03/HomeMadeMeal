...
<body>
	...
	<div class="jumbotron" style="background-color:#D70F64;border-radius:0;text-align:center">
		<div style="color:white" class="mt-5">There are no items in this cart</div>
		<button class="btn btn-outline-warning mb-5"> Make Order </button>
	</div>
	<div class="jumbotron" style="background-color:#D70F64;border-radius:0;margin-top:-32px">
		<br>
	</div>
